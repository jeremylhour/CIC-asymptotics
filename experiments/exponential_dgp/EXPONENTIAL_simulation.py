...
if __name__ == "__main__":
    ...
    lambda_x = config.get("lambda_x", 0.75)
    ...
    with open(outfile + ".txt", "a") as f:
        f.write(
            "\nlambda_x={:.2f} -- lambda_z={:.2f} -- alpha_y={:.2f} \n".format(
                lambda_x, lambda_z, alpha_y
            ),
        )
    ...
    for sample_size in sample_size_set:
        ...
        for b in range(B):
            ...
            _, empirical_quantile = estimator_unknown_ranks(
